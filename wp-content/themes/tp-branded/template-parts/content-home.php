...
<div id="inner-content-wrapper" class="wrapper page-section">
    <div id="primary" class="content-area">
        <main id="main" class="site-main" role="main">
            ...
            <?php do_action( 'tp_branded_action_pagination' );  ?>
        </main>
    </div>
	...
	<?php  
	/**
	* Hook - branded_action_pagination.
	*
	* @hooked branded_pagination 
	*/

	/**
	* Hook - branded_infinite_loader_spinner_action.
	*
	* @hooked branded_infinite_loader_spinner 
	*/

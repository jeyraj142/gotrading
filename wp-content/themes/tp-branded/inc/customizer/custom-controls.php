 ...
 */
class Tp_Branded_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Tp_Branded_Dropdown_Category_Control extends WP_Customize_Control {
...
class Tp_Branded_Note_Control extends WP_Customize_Control {
...
class Tp_Branded_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Tp_Branded_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="tp-branded-chosen-select" <?php $this->link(); ?>>
                    <?php
...
class Tp_Branded_Dropdown_Multiple_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="tp-branded-chosen-select" multiple <?php $this->link(); ?>>
                    <?php
                    foreach ( $this->choices as $value => $label )
                        echo '<option value="' . esc_attr( $value ) . '"' . selected( $this->value(), $value, false ) . '>' . esc_html( $label ) . '</option>';
                    ?>
 ...
 */
class Tp_Branded_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class Tp_Branded_Customize_Sortable_Control extends WP_Customize_Control {
  ...
  public function render_content() {
    ...
    <ul class="tp-branded-sortable-list">
 
      <?php
       foreach ( $values_choices as $value ){  ?>
	        <li>
	            <input class="tp-branded-sortable-input sortable-hideme" name="<?php echo esc_attr( $value ); ?> " type="hidden"  value="<?php echo esc_attr( $value ); ?>" />
	            <span class ="menu-item-handle sortable-span"> <?php echo esc_attr( $choices[$value] ); ?> </span>
	          <i class="dashicons dashicons-menu tp-branded-drag-handle"></i>
	        </li>
        ...
        <li class="sortable-hideme">
          <input class="tp-branded-sortable-value" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
        </li>
...
class Tp_Branded_Customize_Horizontal_Line extends WP_Customize_Control {
 ...
 * @since  1.0.0
 */
class Tp_Branded_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
...
class Tp_Branded_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="tp-branded-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'tp-branded' ); ?>" class="tp-branded-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}

class Tp_Branded_Customize_Column extends WP_Customize_Control {
	public $type = 'hr';
...
class Tp_Branded_Multiple_Dropdown_Chooser extends WP_Customize_Control{
	public $type = 'dropdown_chooser';
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="tp-branded-chosen-select" <?php $this->link(); ?> multiple>
                    <?php
                    foreach ( $this->choices as $value => $label )
                        echo '<option value="' . esc_attr( $value ) . '"' . selected( $this->value(), $value, false ) . '>' . esc_html( $label ) . '</option>';
                    ?>

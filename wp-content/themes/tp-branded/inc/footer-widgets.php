...
class Tp_Branded_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'tp_branded';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'tp-branded' ), $i ),
...
// Initialize.
$branded_footer_widgets = new Tp_Branded_Footer_Widgets();

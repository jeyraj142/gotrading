...
// Title
  ...
  if(is_search()) {
    if ( have_posts() ) $title_creativeily = __( 'Search Results for:', 'speedy-growth' ).' ' . get_search_query() ;
    else $title_creativeily = __( 'Nothing Found', 'speedy-growth' );
  }

  if(is_404()) {
    $title_creativeily = __( 'Oops! That page can&rsquo;t be found', 'speedy-growth' );
  }

 ...
 *
 * @package speedy-growth
 */

/** 
 * Set up the WordPress core custom header feature.
 *
 * @uses speedy_growth_header_style()
 */
function speedy_growth_custom_header_setup() {
	...
	register_default_headers( array(
		'header-bg' => array(
			...
			'description'   => _x( 'Default', 'Default header image', 'speedy-growth' )
			),	
		) );

}
add_action( 'after_setup_theme', 'speedy_growth_custom_header_setup' );

if ( ! function_exists( 'creativeily_header_style' ) ) :
	/**
	 * Styles the header image and text displayed on the blog.
	 *
	 * @see speedy_growth_custom_header_setup().
	 */
